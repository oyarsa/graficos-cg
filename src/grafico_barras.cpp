...
Grafico_barras::Grafico_barras(GLfloat tamanho_x, GLfloat tamanho_y)
    : Grafico_barras({}, tamanho_x, tamanho_y) {}

Grafico_barras::Grafico_barras(const std::vector<Servidor>& servidores,
...
void Grafico_barras::desenha()
{
    ...
    for (Servidor servidor : servidores()) {
        desenha_barras(pos_x, tamanho_barras, servidor);
...
void Grafico_barras::desenha_eixos()
{
...
std::pair<GLfloat, GLfloat> Grafico_barras::calcular_dimensoes_x()
{
...
void Grafico_barras::desenha_barras(GLfloat pos_x, GLfloat tamanho_barras,
                                    const Servidor& servidor)
{
    // Desenhar duas barras, uma ao lado da outra
        // A primeira da cor Grafico::cor_horda com altura servidor.porcentagem_horda()
        // A segunda da cor Grafico::cor_alianca com altura servidor.porcentagem_alianca()
        // Cada uma deve ter tamanho_barras/2 de largura
...
void Grafico_barras::desenha_legenda()
{
...
void Grafico_barras::configura_window(GLsizei x, GLsizei y,
                                      GLsizei w, GLsizei h)
{
    glViewport(x, y, w, h);
